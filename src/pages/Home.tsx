...
const Home = () => {
  ...
  return (
    <main>
      ...
      {/* ── HERO ── */}
      <section style={{ background: 'var(--bg-soft)', paddingTop: '200px', paddingBottom: '120px', borderBottom: '1px solid var(--border)' }}>
        <div className="container">
          ...
          <div style={{ textAlign: 'center' }} className="animate-fade">
            ...
            <p style={{ color: 'var(--text-muted)', fontSize: '1.4rem', lineHeight: '1.7', marginBottom: '3rem', maxWidth: '800px', margin: '0 auto' }}>
            ...
            {/* GMB Rating Badge */}
            <div style={{ display: 'flex', justifyContent: 'center', alignItems: 'center', gap: '1.5rem', flexWrap: 'wrap', marginBottom: '4rem' }}>
