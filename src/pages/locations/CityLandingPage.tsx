...
const CityLandingPage: React.FC<CityLandingPageProps> = ({ city }) => {
  return (
    <main>
      ...
      <section className="section-padding" style={{ background: 'var(--bg-surface)', paddingTop: '180px', borderBottom: '1px solid var(--border-main)' }}>
        <div className="container">
          <div className="flex flex-col md-flex justify-between items-center gap-12">
            <div style={{ flex: 1 }}>
              <div style={{ color: 'var(--primary)', fontWeight: '700', marginBottom: '1rem', textTransform: 'uppercase', letterSpacing: '0.2em' }}>
                LOCAL EXPERTISE | GLOBAL DELIVERY
              </div>
              <h1 style={{ fontSize: '4rem', marginBottom: '1.5rem', fontWeight: '800' }}>The Leading <span style={{ color: 'var(--primary)' }}>Software</span> Company in {city}</h1>
      ...
      <section className="section-padding">
        <div className="container">
          <div className="text-center" style={{ marginBottom: '5rem' }}>
            <h2 style={{ fontSize: '3rem', fontWeight: '800' }}>Specialized for <span style={{ color: 'var(--primary)' }}>{city}</span></h2>
          ...
          <div className="grid grid-cols-1 md-grid-cols-3 gap-8">
            <div className="glass-card">
              <div style={{ color: 'var(--primary)', marginBottom: '1.5rem' }}><Zap size={40} /></div>
            ...
            <div className="glass-card">
              <div style={{ color: 'var(--primary)', marginBottom: '1.5rem' }}><Shield size={40} /></div>
      ...
      <section className="section-padding">
        <div className="container">
          <div style={{ background: 'var(--primary)', borderRadius: '32px', padding: '5rem', textAlign: 'center', color: 'white' }}>
            ...
            <Link to="/contact" className="btn btn-outline" style={{ background: 'white', color: 'var(--primary)', border: 'none', padding: '1.2rem 4rem', borderRadius: '50px' }}>
              Schedule Call Now
            </Link>
          </div>
        </div>
